...
import 'package:linktobd/view/private_chat.dart';
...
class _MessagesState extends State<Messages> {
  ...
  Future<void> saveMessagesLocal(List<Map<String, dynamic>> messages) async {
    ...
    List<String> columns = [
      'id', 'name', 'username', 'message', 'photoUrl', 'time', 'uuid', 'con_token'
    ];
  ...
  Future<List<Map<String, dynamic>>> fetchMessageDataLocal() async {
    ...
    DbTable messageTable = DbTable(tableName: 'my_message', columns: columns);
    await dbManager.ensureTableExists(messageTable);
          ...
          return Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String conToken = message["con_token"].toString() ?? '';
                return Padding(
                      ...
                      Navigator.of(context).push(
                          CustomPageRouteAnimator(
                            child: PrivateChat(
                              ...
                              username: username,
                              chatPartnerImage: 'https://linktobd.com/assets/user_dp/$photoUrl',
                              conToken: conToken,
                            ),
                            direction: 'fromRight',
                          )
